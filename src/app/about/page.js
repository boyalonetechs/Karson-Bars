    ...
    <div className="min-h-screen bg-[#FFFDF0] text-[#1E1E1E] font-sans overflow-x-clip">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={idx} className="bg-white/60 border border-yellow-200/50 rounded-2xl p-5 flex items-start space-x-4 shadow-sm">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            <div className="lg:col-span-2 space-y-4 text-sm text-red-50 leading-relaxed">
              ...
              <p>
                He has developed, published and presented many products from African breadfruit seeds in local and international conferences and workshops. These products included but not limited to snack bars, cookies, bread, biscuits, spaghetti-like products, doughnuts, cakes and chin chin, breadfruit oil and breadfruit milk.
              </p>
            </div>

            <div className="space-y-4">
              {[
                { icon: GraduationCap, title: 'Professor of Food Science & Technology', sub: 'Postharvest management of crops, particularly African breadfruit seed utilisation.' },
                { icon: FlaskConical, title: 'Food Extrusion Technologist', sub: 'Process optimization and product formulation with value addition as the target.' },
                { icon: Globe, title: '8+ Countries & Counting', sub: 'Has taken his research to the USA, Canada, Brazil and beyond.' },
              ].map((item, idx) => (
                <div key={idx} className="bg-[#FAD02C] text-[#1E1E1E] p-5 rounded-xl flex items-start space-x-4 shadow-md">
                  ...
                  <div>
                    <h3 className="font-bold text-sm md:text-base mb-1">{item.title}</h3>
                    <p className="text-xs text-gray-800 leading-relaxed">{item.sub}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
          <div className="lg:col-span-3 space-y-4 text-sm text-gray-700 leading-relaxed">
            <h2 className="text-2xl md:text-3xl font-bold text-[#1E1E1E] mb-2">The Challenge at Retirement</h2>
            <p>
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#FAD02C] text-[#1E1E1E] p-8 rounded-2xl shadow-md">
              ...
              <p className="text-xs text-gray-800 mt-3">Inaugural Lecture · 2018</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-[#FAD02C] text-[#1E1E1E] p-6 rounded-2xl flex flex-col items-start space-y-4 shadow-md">
          ...
          <p className="text-center text-xs md:text-sm text-red-100 max-w-3xl mx-auto mt-10">
            Topics covered included Research and Innovation, Research to Commercialization, Food Value Addition and Sustainability, and the Role of the Nigeria Institute of Food Science and Technology in a Depressed Economy — with African breadfruit utilization and research experiences as key references.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: Sprout, stat: '28%', label: 'High Protein', sub: 'For sustained nutrition' },
            { icon: Wheat, stat: '25%', label: 'Dietary Fibre', sub: 'Supports digestion and satiety' },
            { icon: Sparkles, stat: 'Rich', label: 'Vitamins & Minerals', sub: 'Naturally wholesome' },
            { icon: Heart, stat: 'Friendly', label: 'Diabetes Friendly', sub: 'Formulated for young and adults' },
          ].map((item, idx) => (
            <div key={idx} className="bg-white/60 border border-yellow-200/50 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-[#FAD02C] w-11 h-11 mx-auto rounded-full flex items-center justify-center mb-4">
                <item.icon size={20} />
              </div>
              <h3 className="text-3xl font-black text-[#801B1B]">{item.stat}</h3>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: Sun, title: 'Tasty & Convenient', sub: 'A quick serve to visitors and a companion while hurrying to work or at office, meetings, classrooms or conferences.' },
            { icon: Heart, title: 'Nutritious & Satiable', sub: 'Rich in protein, dietary fibre, vitamins and minerals — keeps one off intermittent hunger while at work.' },
            { icon: Milk, title: 'Enhances Fluid Intake', sub: 'Pairs beautifully with water, breakfast tea, coffee, midday beverages and local fluid preparations.' },
            { icon: Leaf, title: 'Wholesome & Plant-Based', sub: 'Cheap compared to its animal nutritional equivalents. Well packaged and convenient.' },
          ].map((item, idx) => (
            <div key={idx} className="bg-[#FAD02C] text-[#1E1E1E] p-6 rounded-2xl shadow-md flex flex-col items-start text-left space-y-4">
